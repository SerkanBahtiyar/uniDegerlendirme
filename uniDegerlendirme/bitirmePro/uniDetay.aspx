<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="uniDetay.aspx.cs" Inherits="bitirmePro.uniDetay" %>
			  ...
			  <div class="single-grid">
				  <asp:Repeater ID="Repeater1" runat="server">
					  <ItemTemplate>
						   ...
						   <img src="<%# Eval("uniGORSEL")%>" alt="" style="height: 350px; width: 600px" />

                                <h3><%#Eval("uniGBASLIK") %></h3>
                                <p><%#Eval("uniICERIK") %></p>
					  </ItemTemplate>
				  </asp:Repeater>
                        ...
                        <ItemTemplate>
                            <ul class="comment-list">
                                <li>
                                    ...
                                    <div class="desc">
                                        <p style="font-weight: bolder"><%#Eval("kisiAd") %> </p> : <p> <%#Eval("yorum") %></p>
                                    </div>
