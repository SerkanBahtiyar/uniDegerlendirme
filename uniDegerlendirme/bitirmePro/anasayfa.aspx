<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="anasayfa.aspx.cs" Inherits="bitirmePro.WebForm1" %>
                        ...
                        <div class="content-grid">
                            <div class="content-grid-info">
                                ...
                                <div class="post-info">
                                    ...
                                    <p><%# Eval("uniICERIK")%></p>
                                       <%--<a href="bolumler.Aspx?bolumid=<%# Eval("uniId")%>"><%# Eval("bolumAd") %>"><span></span>Bölümler</a>--%>
                 ...
                 <%--    <div class="categories">
                    ...
                    <ul>
                        <asp:Repeater ID="Repeater5" runat="server">
                            <ItemTemplate>
                                <li><a href="bolumler.Aspx?kategoriid=<%# Eval("bolumid")%>"><%# Eval("bolumAd") %></a> </li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
                </div>--%>
