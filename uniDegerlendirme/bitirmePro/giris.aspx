<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris.aspx.cs" Inherits="bitirmePro.giris" %>
   ...
   <body>
      <div class="mid-class">
         <div class="art-right-w3ls">
            <h2>Üniversite Değerlendirme Admin Login Paneli</h2>
         ...
         <div class="art-left-w3ls">
            <h1 class="header-w3ls">
               Üniversite Değerlendirme Admin Sayfası
            </h1>
         </div>
      </div>
      <footer class="bottem-wthree-footer">
         <p>
          2023 serkan bahtiyar
         </p>
      </footer>
   </body>
</html>
